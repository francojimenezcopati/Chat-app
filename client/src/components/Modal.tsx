...
const Modal: React.FC<Props> = ({
	...
	return (
		<div className="fixed w-screen h-screen left-0 top-0 bg-slate-800/80 z-30 ">
			<div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-fit h-fit bg-gray-900 rounded-2xl p-5 ring ring-slate-600/40">
